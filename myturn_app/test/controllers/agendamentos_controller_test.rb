...
class AgendamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create agendamento" do
    assert_difference('Agendamento.count') do
      post agendamentos_url, params: { agendamento: { Data: @agendamento.Data, ID_Fornecedor: @agendamento.ID_Fornecedor, ID_TipoArmazenamento: @agendamento.ID_TipoArmazenamento, ID_Usuario: @agendamento.ID_Usuario, Paletizacao: @agendamento.Paletizacao, Qtd_Trabalhadores: @agendamento.Qtd_Trabalhadores, TempoEntrega: @agendamento.TempoEntrega } }
    end
  ...
  test "should update agendamento" do
    patch agendamento_url(@agendamento), params: { agendamento: { Data: @agendamento.Data, ID_Fornecedor: @agendamento.ID_Fornecedor, ID_TipoArmazenamento: @agendamento.ID_TipoArmazenamento, ID_Usuario: @agendamento.ID_Usuario, Paletizacao: @agendamento.Paletizacao, Qtd_Trabalhadores: @agendamento.Qtd_Trabalhadores, TempoEntrega: @agendamento.TempoEntrega } }
