...
class FornecedorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedors_url, params: { fornecedor: { CNPJ: @fornecedor.CNPJ, razaosocial: @fornecedor.razaosocial } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { CNPJ: @fornecedor.CNPJ, razaosocial: @fornecedor.razaosocial } }
